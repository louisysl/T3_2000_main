...
Von Powershell aus gibt es die Sogenannte kommentarbasierte Hilfe. Sie dient dazu Funktionen in ihren ganzen Möglichkeiten darzustellen.  

<!-- https://docs.microsoft.com/de-de/powershell/scripting/developer/help/examples-of-comment-based-help?view=powershell-7.2 -->
...
Einleitend gab es dazu kleine Aufgaben zu lösen, wie das Anlegen verschiedener Organisationseinheiten  die sich wie folgt aufgebaut haben: 
<!-- tbd -->


<!-- 
zur Automatisierung Für diese GPOs galt es verschiedene Aufgaben zu lösen. 
Gearbeitet wurde an Server Konfigurationen. 
Zur besseren Vertrautheit wurden einführend kleine Aufgaben gelöst. 
  -->
...
## Microsoft Visio
<!-- Zur Doklumentiewrung/ Visualisierung wurde Microsoft Visio verwendet. eigenes Visio -->
