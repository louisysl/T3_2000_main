...
Hierzu wurde sich mit dem Entwickler der Abteilung zusammen gesetzt und das Skript mit den Relevanten Parametern in einer Usecaseanalyse dokumentiert. Diese Usecaseanalyse ist für den späteren Transfer zwischen Service Now (SNOW) und der Beat Box (BBX) notwendig gewesen, damit die Entwickler der einzelnen Frameworks genaustens über die relevanten Serviceparameter Bescheid wissen. Als Erstes wurde sich der Anmeldung gewidmet. 
