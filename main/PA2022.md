...
Die vier Dimensionen des Service Management dienen der effektiven und effizienten Förderung der Wertschöpfung für Kunden und Stakeholder, die durch Produkte und Dienstleistungen des Unternehmens widergespiegelt werden. [@kempterITILITProcess]

https://blog.itil.org/2019/04/itil4-der-ganzheitliche-ansatz-mit-vier-dimensionen/ 


Das Service Wertesystem beschreibt wie alle Komponenten und Aktivitäten einer Organisation zusammenwirken, um die Wertschöpfung zu erzielen. Es ist ein Betriebsmodell zur Erzeugung, Bereitstellung und kontinuierlichen Verbesserung von Services und soll zudem Flexibilität fördern und Silodenken vermeiden. Dabei stehen Nachfrage und Wert eng immer miteinander im Wechsel. Grafisch kann es mit den folgenden fünf Schlüsselaktivitäten dargestellt werden:

<!-- svs Bild  
BeschreibungITILBest 
https://www.kess-buchsein.de/schulungen/itil-4/was-ist-itil-4 -->

Auf den Themenblock Practices beziehungsweise ein spezifisches Scope an Practices wird im weiteren Verlauf noch genauer eingegangen, da diese Themenbereiche Aufgabenrelevant waren. Auf die restlichen Komponenten wird nicht tiefer eingegangen. 




### SSR-Framework
Der Sektor Request Fulfilment, in ITIL, beschäftigt sich mit der Bearbeitung von Standard Service Requests. In den meisten Fällen sind diese Changes eher klein gehalten und beziehen sich eher auf Changes (Standard-Changes). Es wird beispielsweise eine Passwort- oder Informations-Änderung angefordert.
