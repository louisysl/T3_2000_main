...
$mandant =
$rmt =
$druckertyp_id = "Filiale"
$ipp = "1/0"

``` -->
<!-- tbd -->

Nach einer Debatte, ob die Änderung, beziehungsweise der Umzug, als SSR angeboten werden soll, kam man zu dem Entschluss, dass sich der Mehraufwand eines extra angelegten SSRs, mit nur geringfügigem Mehrwert für den Kunden, nicht lohne. Somit wurde sich als nächstes mit der Löschung eines angelegten Druckers in der Datenbank beschäftigt. 
